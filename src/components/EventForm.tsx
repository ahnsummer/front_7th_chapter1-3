...
type EventFormProps = {
  ...
  setRepeatType: (_repeatType: RepeatType) => void;
  ...
  onSubmit: () => void;
  getTimeErrorMessage: (_start: string, _end: string) => TimeValidationResult;
};
        ...
        <Stack spacing={2}>
          <FormControl fullWidth>
            ...
            <Select
              ...
              aria-label="반복 유형"
              onChange={(e) =>
                setRepeatType(e.target.value as 'daily' | 'weekly' | 'monthly' | 'yearly')
              }
            >
